...
public class IndexAction {
	...
	public String GotoMap() {
		...
		@ResponseBody
		public Result Order(OrderForm orderForm) throws ParseException {
		...
		@ResponseBody
		public Result foodOrder(String userId, String dinnerTime, String dinnerNumber) throws ParseException{
			Reserve objReserve = toReserveBiz.foodToReserve(userId,dinnerTime,dinnerNumber);
		...
		@ResponseBody
		public Result entertainmentOrder(String userId, String entertainmentTime, String entertainmentType) throws ParseException{
			Reserve objReserve = toReserveBiz.entertainmentToReserve(userId,entertainmentTime,entertainmentType);
